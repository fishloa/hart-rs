...
impl CommandResponse for Cmd48Response {
    const COMMAND_NUMBER: u8 = READ_ADDITIONAL_STATUS;
...
mod tests {
    ...
    fn test_cmd48_command_number() {
        assert_eq!(Cmd48Request::COMMAND_NUMBER, 48);
        assert_eq!(Cmd48Response::COMMAND_NUMBER, 48);
    }
