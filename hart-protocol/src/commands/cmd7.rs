...
pub struct Cmd7Response {
    pub polling_address: u8,
    pub loop_current_mode: u8,
}

impl CommandRequest for Cmd7Request {
...
impl CommandResponse for Cmd7Response {
    const COMMAND_NUMBER: u8 = READ_LOOP_CONFIG;
...
mod tests {
    ...
    fn test_cmd7_command_number() {
        assert_eq!(Cmd7Request::COMMAND_NUMBER, 7);
        assert_eq!(Cmd7Response::COMMAND_NUMBER, 7);
    }
}
